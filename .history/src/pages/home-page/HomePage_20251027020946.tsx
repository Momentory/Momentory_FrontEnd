  ...
  return (
    <div className="w-full min-h-screen bg-white overflow-y-auto pb-24">
      ...
      <section className="px-6 mt-10">
        ...
        >
          {[
            { img: "/images/sprout.png", label: "성장현황" },
            { img: "/images/location-pin.png", label: "나의지도" },
            { img: "/images/photo-gallery.png", label: "최근사진" },
            { img: "/images/star.png", label: "추천여행" },
          ].map((item) => (
      ...
      {/* 최근 업로드 사진 */}
      <section className="px-6 mt-10">
        <h2 className="text-[17px] font-semibold mb-3">Recent Photos</h2>
        <div className="flex gap-3 overflow-x-auto scrollbar-hide">
      ...
      <section className="px-6 mt-10 mb-10">
        <h2 className="text-[17px] font-semibold mb-3">Recommended Places This Week</h2>
