...
export default function HomePage() {
  ...
  useEffect(() => {
    const handleUploadClick = (e: MouseEvent) => {
      ...
      // href="/upload" 또는 "업로드" 텍스트가 들어간 버튼 클릭 시
      if (target.closest("a[href='/upload']") || target.textContent?.includes("업로드")) {
    ...
    return () => document.removeEventListener("click", handleUploadClick);
  }, []);
