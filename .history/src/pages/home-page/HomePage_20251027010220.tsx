...
// ⚠️ public 폴더의 이미지는 import 하지 않습니다.
//    캐릭터 이미지는 'char1.png'를 예시로 사용했습니다. 실제 파일명과 경로를 확인해주세요.
...
export default function HomePage() {
  ...
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      {/* --- 💅 배경 + 인사말 + 캐릭터 섹션 (사진처럼 나오게 수정) --- */}
      <div
        className="relative w-full h-[220px] overflow-hidden bg-cover bg-center" // 높이와 배경 스타일 적용
        style={{
          // public 폴더의 이미지는 '/images/bg.png'와 같이 문자열로 바로 사용합니다.
          // 그라데이션과 이미지 URL을 쉼표로 구분하여 동시에 적용합니다.
