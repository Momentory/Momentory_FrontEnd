    ...
    <div className="w-full min-h-screen bg-white overflow-y-auto pb-28 relative">
      ...
      <div className="fixed bottom-6 right-6 z-30">
        <button
          ...
          className="w-[60px] h-[60px] bg-[#FF7070] text-white rounded-full shadow-lg text-[30px] flex items-center justify-center hover:bg-[#ff5c5c] transition active:scale-95"
        >
          +
        </button>
      </div>
