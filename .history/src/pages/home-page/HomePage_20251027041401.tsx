        ...
        >
          ...
          >
            ...
            <button
              ...
              className="w-full text-left p-4 flex items-center gap-4 text-gray-700 hover:bg-gray-50 rounded-lg"
            >
            ...
            <button
              onClick={() => setIsUploadModalOpen(false)}
              className="mt-4 w-full text-gray-500 text-[14px] font-medium hover:text-gray-700"
            >
              Cancel
            </button>
          </div>
