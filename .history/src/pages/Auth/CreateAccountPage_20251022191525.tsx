...
export default function CreateAccountPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white px-[28px]">
      {/* 🔹 상단 화살표 + 타이틀 */}
      <div className="relative w-full mb-8 max-w-[332px]">
        <img
          src="/images/109618.png"
          alt="뒤로가기"
          className="absolute -top-16 left-2 w-[35px] h-[35px] cursor-pointer"
          onClick={() => navigate(-1)}
        />
        <h1 className="text-[24px] font-semibold text-black mb-2 text-center">
          회원 가입
        </h1>
      </div>
