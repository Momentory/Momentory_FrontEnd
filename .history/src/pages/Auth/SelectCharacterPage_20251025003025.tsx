...
export default function SelectCharacterPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-between min-h-screen bg-white px-[20px] pt-[100px] pb-[40px] relative">
      ...
      {/* 캐릭터 선택 */}
      <div className="flex justify-center items-center gap-[30px] mb-50">
        {characters.map((char) => (
          <div
            key={char.id}
            className={`relative w-[330px] h-[330px] cursor-pointer transition-all duration-200 flex items-center justify-center ${
              selected === char.id
                ? "scale-105 drop-shadow-[0_0_10px_rgba(255,112,112,0.5)]"
                : "hover:scale-102"
            }`}
