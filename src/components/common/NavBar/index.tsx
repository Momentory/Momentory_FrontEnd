...
const Navbar = ({ onUploadClick }: NavbarProps) => {
  return (
    <nav
      className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] flex flex-row justify-between px-12 pt-4 z-[100] bg-white shadow-[0px_-4px_4px_0px_rgba(0,0,0,0.15)]"
      style={{
