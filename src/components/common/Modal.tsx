...
const Modal = ({ title, onClose, children }: ModalProps) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-[500] px-5">
      <div className="w-full max-w-xs sm:max-w-sm md:max-w-md relative bg-white rounded-2xl shadow-lg w-80 px-4 py-4 flex flex-col items-center max-h-[80vh] overflow-hidden z-[502]">
